-- 跨轮对比：支撑"改动前后同档位对比"
-- 用法：sed -e "s/__RUN_A__/20260818-014200/" -e "s/__RUN_B__/20260818-021500/" compare_runs.sql | docker exec -i peergrab-mysql mysql -uroot -ppeergrab123456 -D peer_grab
