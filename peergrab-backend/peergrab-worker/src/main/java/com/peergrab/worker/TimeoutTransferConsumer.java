...
public class TimeoutTransferConsumer {
    ...
    public TimeoutTransferConsumer(ClientServiceProvider provider,
                                   ...
                                   @Value("${peergrab.mq.topic.confirm-timeout:errand-confirm-timeout}") String topic,
                                   @Value("${peergrab.mq.group.confirm-timeout:peergrab-timeout-consumer}") String group) {
