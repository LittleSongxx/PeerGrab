...
@TestPropertySource(properties = {
        "peergrab.timeout.confirm-seconds=2",
        "peergrab.timeout.max-transfer-rounds=3",
        "peergrab.mq.enabled=false",
        "peergrab.credit.max-ongoing=10000"
})
...
class TimeoutTransferIT {
    ...
    @Test
    @DisplayName("候选队列为空：任务回退 PUBLISHED，旧 Redis 名额失效并由 DB CAS 重新抢单")
    ...
    void duplicate_timeout_message_transfers_once() {
        ...
        assertEquals(com.peergrab.shared.ErrorCode.SLOT_FULL, firstLoser.code());
